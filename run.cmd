...
uv run main.py -s ja -t vi -i "_temp/ManualTransFile.json" -o "_temp/ManualTransFile_out.json" -m lmstudio -c 4 -b 100 --cache_file "_temp\ManualTransFile_out.json.cache" --ignore_regex "^[0-9]+$"
