...
uv run main.py -s ja -t vi -i "_temp/ManualTransFile.json" -o "_temp/ManualTransFile_out.json" -m google,cerebras,nvidia -c "100,2,8" -b "1,50,50" --cache_file "_temp\ManualTransFile_out.json.cache" --ignore_regex "^[0-9]+$" --api_key_cerebras "" --api_key_nvidia ""
